...
chat_model_mapping = {
    ...
    OpenAIModelName.GPT5: [OpenAIModelName.GPT5],
}
...
class OpenAIProvider(
    ...
    def get_tokenizer(self, model_name: OpenAIModelName) -> ModelTokenizer[int]:
        try:
            ...
            # Handle models not yet supported by tiktoken
            if model_name.startswith("gpt-5"):
                # GPT-5 uses o200k_base encoding
                return tiktoken.get_encoding("o200k_base")
            else:
                # Fallback to cl100k_base for other unsupported models
    ...
    def count_message_tokens(
        ...
        # TODO: check if this is still valid for gpt-4o
            ...
            # GPT-5 follows similar token counting to GPT-4
            tokens_per_message = 3
            tokens_per_name = 1
        else:
    ...
    def _get_chat_completion_args(
        ...
        **kwargs,
        ...
        if model.startswith("gpt-5"):
            # GPT-5 doesn't support max_tokens parameter in the current client library
            # Remove it to avoid the "unsupported parameter" error
