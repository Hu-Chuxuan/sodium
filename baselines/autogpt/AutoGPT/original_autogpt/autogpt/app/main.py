...
async def run_auto_gpt(
    ...
    try:
        ...
        await agent.file_manager.save_state(None)
    finally:
        ...
        metadata = {
            ...
            "cost": 1.25e-06 * agent.llm_provider._settings.budget.usage.prompt_tokens + 10e-06 * agent.llm_provider._settings.budget.usage.completion_tokens,
